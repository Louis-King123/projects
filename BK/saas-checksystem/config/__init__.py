...
# 应用 ID
APP_CODE = "saas-checksystem"
# 应用用于调用云 API 的 Secret
SECRET_KEY = "23a8ecab-45f4-4e71-8442-d90845d9b09d"
...
BK_URL = "http://paas.bkce.com"

# 第三方邮件授权码
mail_pass = "ewkfrjqiuvfichia"  # 授权码
sender = '3284025108@qq.com'    # 发送人
