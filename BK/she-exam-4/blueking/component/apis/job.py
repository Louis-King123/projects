...
class CollectionsJOB(object):
    ...
    def __init__(self, client):
        self.client = client
        # 启动作业 v2
        self.execute_job_v2 = ComponentAPI(
        ...
        # 查询作业执行状态 v2
        self.get_job_instance_status_v2 = ComponentAPI(
            client=self.client, method='GET',
        ...
        # 快速执行脚本v2
        self.fast_execute_script_v2 = ComponentAPI(
            client=self.client, method='POST',
        ...
        self.fast_execute_script = ComponentAPI(
            client=self.client, method='POST',
            path='/api/c/compapi/v2/jobv3/fast_execute_script/',
            description=u'快速执行脚本'
        )
        # 快速分发文件 v2
        ...
        self.get_job_template_list = ComponentAPI(
            client=self.client, method='GET',
            path='/api/c/compapi/v2/jobv3/get_job_template_list/',
            description=u'获取job模板列表'
        )
